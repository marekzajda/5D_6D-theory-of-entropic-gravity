...
M_BH = 8.86e8  # Black hole mass [M_sol] for 3C 273
M_dot_Edd = (4 * np.pi * G * M_BH * M_sun * 1.673e-27) / (6.652e-29 * c)  # Eddington accretion rate in kg/s
M_dot = 0.12 * M_dot_Edd  # Observed accretion rate
T_BH = 3.48e-8  # Hawking temperature [K] for 3C 273
T_s_astrophysical = 3.02e-5  # s/m, from UEST 5.0 for I4-I6
...
S_dot_calibrated = 1.11e8  # s, adjusted from cosmic scale Ts to match peaks
S_dot_calculated = (8.25e94 * k_B) / 0.025  # J/K·s, updated using T_s from UEST 5.0
...
def find_peaks(xf, power):
    ...
    return [(xf[i], power[i]) for i in peaks if xf[i] > 0]
...
def chi2_harmonic(peaks, harmonics_cal, harmonics_theo, sigma=0.12):  # Reduced tolerance to lower matches and False Alarm Prob
...
def plot_spectrum(xf, power, peaks, harmonics_cal, harmonics_theo, nyquist_freq, S_dot_cal, S_dot_calc, red_noise, A, alpha, T_BH):
    ...
    plt.title(f'3C 273 Power Spectrum (S_dot_cal = {S_dot_cal:.2e} s, S_dot_calc = {S_dot_calc:.2e} J/K·s)', fontsize=14)
    plt.grid(True, which="both", alpha=0.5)
    plt.legend(loc='upper right')
    plt.savefig('C:/Users/Marek Zajda/Desktop/3C273_Analyza/aktualizace/3c273_spectrum_uest.png', dpi=300, bbox_inches='tight')
    plt.close()
    return top_peaks

def main():
    print("="*60)
    print("3C 273 UEST 5.0 ANALYSIS".center(60))
    print("="*60)
    try:
        ...
        fits_files = [
            'C:/Users/Marek Zajda/Desktop/3C273_Analyza/aktualizace/P0810822201PNX000SRCTSR800A.FITS',
            'C:/Users/Marek Zajda/Desktop/3C273_Analyza/aktualizace/P0810822201PNX000SRCTSR800D.FITS',
            'C:/Users/Marek Zajda/Desktop/3C273_Analyza/aktualizace/P0810822201PNX000SRCTSR802D.FITS',
            'C:/Users/Marek Zajda/Desktop/3C273_Analyza/aktualizace/P0810822201PNX000SRCTSR8001.FITS'
        ]
        print("\nLoading data files...")
        ...
        print("\nGraph saved as '3c273_spectrum_uest.png'")
    except Exception as e:
